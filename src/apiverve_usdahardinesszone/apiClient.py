...
class HardinesszoneAPIClient:
    def __init__(self, api_key, secure=True):
        """
        Initialize the HardinesszoneAPIClient with the API key and secure flag
        ...
        self.secure = secure
        self.base_url = 'https://api.apiverve.com/v1/hardinesszone'
        self.headers = {
