...
class TestHardinesszoneAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = HardinesszoneAPIClient(self.api_key)

    @patch('apiverve_usdahardinesszone.apiClient.requests.get')
